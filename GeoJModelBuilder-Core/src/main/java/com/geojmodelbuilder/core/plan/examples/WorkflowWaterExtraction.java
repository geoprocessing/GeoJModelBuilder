 ...
 */
package com.geojmodelbuilder.core.plan.examples;
 ...
 *
 */
public class WorkflowWaterExtraction {

	private IProcessExec mapcalcProcess(String input1,String input2){
	...
	private  IProcessExec colorsProcess(){
	...
	private  IProcessExec binaryProcess(){
	...
	private  IProcessExec blendProcess(){
