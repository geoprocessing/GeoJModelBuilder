...
public class WPSResourceTreeView extends ViewPart {
	...
	private Tree tree;
	private WPSTreeActionProvider treeActions;
	private WPSResourceRoot root;
	@Override
	public void createPartControl(Composite parent) {
		...
		treeActions = new WPSTreeActionProvider(treeViewer);
	...
	private WPSResourceRoot initializeTree() {
		root = new WPSResourceRoot("Resources");
